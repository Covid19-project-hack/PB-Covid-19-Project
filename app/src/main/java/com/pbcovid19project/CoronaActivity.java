...
import com.pbcovid19project.Adapter.CoronaAdapter;
import com.pbcovid19project.Adapter.FAQAdapter;
import com.pbcovid19project.Models.Corona;
import com.pbcovid19project.Models.FAQ;
import com.pbcovid19project.Models.Persons;
        ...
        JsonObjectRequest request1 = new JsonObjectRequest(Request.Method.GET,url1, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONObject jsonObject = response.getJSONObject("Punjab").getJSONObject("districtData");
